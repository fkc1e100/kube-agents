...
| `overview/release-engineering.md` | Site page | Release lifecycle: SemVer tagging, packaging (.tar.gz, Helm, SBOM), release gates, and hotfix workflows. | Release automation, versioning, SBOM, checksums | Maintainers and release engineers |
