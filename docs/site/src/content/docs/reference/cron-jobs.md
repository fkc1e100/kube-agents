...
| `gce-compute-fleet-audit` | Platform Agent | `40 9 * * *` | — | yes | Run the daily GCE Compute Engine and MIG fleet audit. Read the SOP at 'governance/gce_compute_fleet_sop.md'... |
